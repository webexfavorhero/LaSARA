...
@section('basic-content')
    ...
    <div class="register-section">
        <span class="part-header">企業新登録</span>
        <div class="register-form">
            ...
            @endif
            {!! Form::open(['method' => 'POST', 'url' => '/basic/company']) !!}
            ...
            <div class="custom-input-group">
                ...
                <input type="text" name="huri_company_name" placeholder="フリガナ"/>
            </div>
            <div class="custom-input-group">
                <a class="custom-label">企業名</a>
                <input type="text" name="company_name" placeholder="企業名"/>
            </div>
